...
var $author$project$EffectsTaskDemo$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $elm$core$Debug$log = _Debug_log;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$EffectsTaskDemo$update = F2(
	function (msg, model) {
...
var $author$project$EffectsTaskDemo$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$elm$html$Html$text('Effects task demo')
			]),
		title: 'Elm Effects Task Demo'
	};
};
var $author$project$EffectsTaskDemo$main = $elm$browser$Browser$document(
	{init: $author$project$EffectsTaskDemo$init, subscriptions: $author$project$EffectsTaskDemo$subscriptions, update: $author$project$EffectsTaskDemo$update, view: $author$project$EffectsTaskDemo$view});
_Platform_export({'EffectsTaskDemo':{'init':$author$project$EffectsTaskDemo$main(
